...
<<<<<<< HEAD
      ...
      { id: 4, revenue_type_id: 3, revenue_group_id: 3, description: 'Manutenção Celular', value: 39.90, date: new Date(2026, 1, 3) },
      { id: 5, revenue_type_id: 1, revenue_group_id: 1, description: 'Salário', value: 200.00, date: new Date(2026, 0, 22) },
      { id: 6, revenue_type_id: 2, revenue_group_id: 4, description: 'Venda Mercado Livre', value: 120.88, date: new Date(2026, 1, 10) },
      { id: 7, revenue_type_id: 3, revenue_group_id: 3, description: 'Venda Xbox 360', value: 210.00, date: new Date(2026, 1, 14) },
